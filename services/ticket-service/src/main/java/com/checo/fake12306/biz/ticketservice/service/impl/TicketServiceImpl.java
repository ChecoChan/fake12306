...
package com.checo.fake12306.biz.ticketservice.service.impl;
...
import com.checo.fake12306.biz.ticketservice.common.enums.*;
import com.checo.fake12306.biz.ticketservice.dao.entity.*;
import com.checo.fake12306.biz.ticketservice.dao.mapper.*;
import com.checo.fake12306.biz.ticketservice.dto.domain.PurchaseTicketPassengerDetailDTO;
import com.checo.fake12306.biz.ticketservice.dto.domain.RouteDTO;
import com.checo.fake12306.biz.ticketservice.dto.domain.SeatClassDTO;
import com.checo.fake12306.biz.ticketservice.dto.domain.TicketListDTO;
import com.checo.fake12306.biz.ticketservice.dto.req.*;
import com.checo.fake12306.biz.ticketservice.dto.resp.RefundTicketRespDTO;
import com.checo.fake12306.biz.ticketservice.dto.resp.TicketOrderDetailRespDTO;
import com.checo.fake12306.biz.ticketservice.dto.resp.TicketPageQueryRespDTO;
import com.checo.fake12306.biz.ticketservice.dto.resp.TicketPurchaseRespDTO;
import com.checo.fake12306.biz.ticketservice.remote.PayRemoteService;
import com.checo.fake12306.biz.ticketservice.remote.TicketOrderRemoteService;
import com.checo.fake12306.biz.ticketservice.remote.dto.*;
import com.checo.fake12306.biz.ticketservice.service.SeatService;
import com.checo.fake12306.biz.ticketservice.service.TicketService;
import com.checo.fake12306.biz.ticketservice.service.TrainStationService;
import com.checo.fake12306.biz.ticketservice.service.cache.SeatMarginCacheLoader;
import com.checo.fake12306.biz.ticketservice.service.handler.ticket.dto.TrainPurchaseTicketRespDTO;
import com.checo.fake12306.biz.ticketservice.service.handler.ticket.select.TrainSeatTypeSelector;
import com.checo.fake12306.biz.ticketservice.service.handler.ticket.tokenbucket.TicketAvailabilityTokenBucket;
import com.checo.fake12306.biz.ticketservice.toolkit.DateUtil;
import com.checo.fake12306.biz.ticketservice.toolkit.TimeStringComparator;
...
import com.checo.fake12306.framework.starter.cache.toolkit.CacheUtil;
import com.checo.fake12306.framework.starter.common.toolkit.BeanUtil;
import com.checo.fake12306.framework.starter.convention.exception.ServiceException;
import com.checo.fake12306.framework.starter.convention.result.Result;
import com.checo.fake12306.framework.starter.designpattern.chain.AbstractChainContext;
import com.checo.fake12306.framework.starter.user.core.UserContext;
...
import static com.checo.fake12306.biz.ticketservice.common.constant.Fake12306Constant.ADVANCE_TICKET_DAY;
import static com.checo.fake12306.biz.ticketservice.common.constant.RedisKeyConstant.*;
import static com.checo.fake12306.biz.ticketservice.toolkit.DateUtil.convertDateToLocalTime;
...
public class TicketServiceImpl extends ServiceImpl<TicketMapper, TicketDO> implements TicketService, CommandLineRunner {
    ...
    public void cancelTicketOrder(CancelTicketOrderReqDTO requestParam) {
        ...
        if (cancelOrderResult.isSuccess() && !StrUtil.equals(ticketAvailabilityCacheUpdateType, "binlog")) {
            Result<com.checo.fake12306.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO> ticketOrderDetailResult = ticketOrderRemoteService.queryTicketOrderByOrderSn(requestParam.getOrderSn());
            com.checo.fake12306.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO ticketOrderDetail = ticketOrderDetailResult.getData();
    ...
    public RefundTicketRespDTO commonTicketRefund(RefundTicketReqDTO requestParam) {
        ...
        Result<com.checo.fake12306.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO> orderDetailRespDTOResult = ticketOrderRemoteService.queryTicketOrderByOrderSn(requestParam.getOrderSn());
        if (!orderDetailRespDTOResult.isSuccess() && Objects.isNull(orderDetailRespDTOResult.getData())) {
            throw new ServiceException("车票订单不存在");
        }
        com.checo.fake12306.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO ticketOrderDetailRespDTO = orderDetailRespDTOResult.getData();
