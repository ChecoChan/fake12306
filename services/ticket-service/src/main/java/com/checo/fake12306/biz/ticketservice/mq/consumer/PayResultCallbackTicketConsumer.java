...
import com.checo.fake12306.biz.ticketservice.common.enums.SeatStatusEnum;
import com.checo.fake12306.biz.ticketservice.dao.entity.SeatDO;
import com.checo.fake12306.biz.ticketservice.dao.mapper.SeatMapper;
import com.checo.fake12306.biz.ticketservice.mq.domain.MessageWrapper;
import com.checo.fake12306.biz.ticketservice.mq.event.PayResultCallbackTicketEvent;
...
public class PayResultCallbackTicketConsumer implements RocketMQListener<MessageWrapper<PayResultCallbackTicketEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "fake12306-ticket:pay_result_callback:",
