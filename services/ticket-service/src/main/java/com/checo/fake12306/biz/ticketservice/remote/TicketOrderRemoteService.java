...
package com.checo.fake12306.biz.ticketservice.remote;

import com.checo.fake12306.biz.ticketservice.dto.req.CancelTicketOrderReqDTO;
import com.checo.fake12306.biz.ticketservice.dto.req.TicketOrderItemQueryReqDTO;
import com.checo.fake12306.biz.ticketservice.remote.dto.TicketOrderCreateRemoteReqDTO;
 ...
 * 车票订单远程服务调用
 */
@FeignClient(value = "fake12306-order${unique-name:}-service", url = "${aggregation.remote-url:}")
