...
package com.checo.fake12306.biz.orderservice.mq.consumer;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.apache.rocketmq.spring.annotation.RocketMQMessageListener;
import org.apache.rocketmq.spring.core.RocketMQListener;
import com.checo.fake12306.biz.orderservice.common.constant.OrderRocketMQConstant;
...
import com.checo.fake12306.biz.orderservice.dto.domain.OrderItemStatusReversalDTO;
import com.checo.fake12306.biz.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import com.checo.fake12306.biz.orderservice.mq.domain.MessageWrapper;
import com.checo.fake12306.biz.orderservice.mq.event.RefundResultCallbackOrderEvent;
...
public class RefundResultCallbackOrderConsumer implements RocketMQListener<MessageWrapper<RefundResultCallbackOrderEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "fake12306-order:refund_result_callback:",
