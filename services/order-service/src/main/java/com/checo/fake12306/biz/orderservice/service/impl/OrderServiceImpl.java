...
package com.checo.fake12306.biz.orderservice.service.impl;
...
import com.checo.fake12306.biz.orderservice.common.enums.OrderCanalErrorCodeEnum;
import com.checo.fake12306.biz.orderservice.common.enums.OrderItemStatusEnum;
import com.checo.fake12306.biz.orderservice.common.enums.OrderStatusEnum;
import com.checo.fake12306.biz.orderservice.dao.entity.OrderDO;
import com.checo.fake12306.biz.orderservice.dao.entity.OrderItemDO;
import com.checo.fake12306.biz.orderservice.dao.entity.OrderItemPassengerDO;
import com.checo.fake12306.biz.orderservice.dao.mapper.OrderItemMapper;
import com.checo.fake12306.biz.orderservice.dao.mapper.OrderMapper;
import com.checo.fake12306.biz.orderservice.dto.domain.OrderStatusReversalDTO;
import com.checo.fake12306.biz.orderservice.dto.req.*;
import com.checo.fake12306.biz.orderservice.dto.resp.TicketOrderDetailRespDTO;
import com.checo.fake12306.biz.orderservice.dto.resp.TicketOrderDetailSelfRespDTO;
import com.checo.fake12306.biz.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import com.checo.fake12306.biz.orderservice.mq.event.DelayCloseOrderEvent;
import com.checo.fake12306.biz.orderservice.mq.event.PayResultCallbackOrderEvent;
import com.checo.fake12306.biz.orderservice.mq.produce.DelayCloseOrderSendProduce;
import com.checo.fake12306.biz.orderservice.remote.UserRemoteService;
import com.checo.fake12306.biz.orderservice.remote.dto.UserQueryActualRespDTO;
import com.checo.fake12306.biz.orderservice.service.OrderItemService;
import com.checo.fake12306.biz.orderservice.service.OrderPassengerRelationService;
import com.checo.fake12306.biz.orderservice.service.OrderService;
import com.checo.fake12306.biz.orderservice.service.orderid.OrderIdGeneratorManager;
import com.checo.fake12306.framework.starter.common.toolkit.BeanUtil;
import com.checo.fake12306.framework.starter.convention.exception.ClientException;
import com.checo.fake12306.framework.starter.convention.exception.ServiceException;
import com.checo.fake12306.framework.starter.convention.page.PageResponse;
import com.checo.fake12306.framework.starter.convention.result.Result;
import com.checo.fake12306.framework.starter.database.toolkit.PageUtil;
