...
package com.checo.fake12306.biz.userservice.controller;
...
public class PassengerController {
     ...
     */
    @Idempotent(
            uniqueKeyPrefix = "fake12306-user:lock_passenger-alter:",
            key = "T(com.checo.fake12306.framework.starter.user.core.UserContext).getUsername()",
