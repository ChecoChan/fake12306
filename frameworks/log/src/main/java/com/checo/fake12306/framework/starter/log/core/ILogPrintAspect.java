...
package com.checo.fake12306.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.checo.fake12306.framework.starter.log.annotation.ILog) || @annotation(com.checo.fake12306.framework.starter.log.annotation.ILog)")
