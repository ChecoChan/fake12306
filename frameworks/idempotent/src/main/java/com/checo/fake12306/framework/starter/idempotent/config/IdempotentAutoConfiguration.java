...
package com.checo.fake12306.framework.starter.idempotent.config;

import com.checo.fake12306.framework.starter.cache.DistributedCache;
import com.checo.fake12306.framework.starter.idempotent.core.IdempotentAspect;
import com.checo.fake12306.framework.starter.idempotent.core.param.IdempotentParamExecuteHandler;
import com.checo.fake12306.framework.starter.idempotent.core.param.IdempotentParamService;
import com.checo.fake12306.framework.starter.idempotent.core.spel.IdempotentSpELByMQExecuteHandler;
import com.checo.fake12306.framework.starter.idempotent.core.spel.IdempotentSpELByRestAPIExecuteHandler;
import com.checo.fake12306.framework.starter.idempotent.core.spel.IdempotentSpELService;
import com.checo.fake12306.framework.starter.idempotent.core.token.IdempotentTokenController;
import com.checo.fake12306.framework.starter.idempotent.core.token.IdempotentTokenExecuteHandler;
import com.checo.fake12306.framework.starter.idempotent.core.token.IdempotentTokenService;
